...
from .permissions import IsOwnerOrReadOnly, IsMessageOwner, IsConversationParticipant
...
class UserViewSet(viewsets.ModelViewSet):
    ...
    def retrieve(self, request, *args, **kwargs):
        """
        Users can only retrieve their own profile unless they are admin
        """
        instance = self.get_object()
        if instance != request.user and not (request.user.is_staff or request.user.role == 'admin'):
            return Response(
    ...
    def conversations(self, request, pk=None):
        ...
        if user != request.user and not (request.user.is_staff or request.user.role == 'admin'):
            return Response(
...
class ConversationViewSet(viewsets.ModelViewSet):
    ...
    def get_permissions(self):
        ...
        - Only participants can view/update conversation
        """
        if self.action == 'create':
            return [IsAuthenticated()]
