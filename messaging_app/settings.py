...
# JWT Configuration - UPDATED FOR UUID USER MODEL
SIMPLE_JWT = {
    ...
    'USER_ID_FIELD': 'user_id',  # CHANGED: Use 'user_id' instead of 'id'
    'USER_ID_CLAIM': 'user_id',  # CHANGED: Use 'user_id' as claim name
